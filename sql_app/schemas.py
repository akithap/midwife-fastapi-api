...
# --- HealthRecord Schemas (No Change) ---
...
# NEW: Schema for Updating a Mother
class MotherUpdate(BaseModel):
    full_name: Optional[str] = None
    address: Optional[str] = None
    contact_number: Optional[str] = None
    # NOTE: 'nic' and 'password' are NOT here, so they cannot be changed.
...
# --- Midwife & Token Schemas (No Change) ---
class MidwifeBase(BaseModel):
    username: str
    full_name: Optional[str] = None

class MidwifeCreate(MidwifeBase):
    password: str
